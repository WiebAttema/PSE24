    ...
    return (
        <div className="Ca_question-container">
            ...
            <div className="Ca_question-content">
                ...
                {editCode ? <textarea class="ca_text-area" value={output.questionCode} onChange={(e) => handleChange('code', e.target.value)} /> : <CodeBlackBox code={output.questionCode} updateOutput={updateOutput} language={language} />}
